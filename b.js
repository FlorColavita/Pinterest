...
//{"58c2b163f02975edc6d03526": [posts del usuario...], "58c2b1635ffb495016775b12": [posts del usuario...]}
const posts = [
  {
    id: 1,
...
const result = posts.reduce((acc, post => {
  const currentPosts = acc[post.userId] ? acc[post.userId] : [];
  currentPosts.push(post);
  
  return {...acc,[post.userId]: currentPosts };
  }, {});
console.log(result);
